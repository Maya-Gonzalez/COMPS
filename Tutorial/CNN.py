...
def get_images(dir_name = 'test_train/train', label_to_class = label_to_class):
    # splits images into training and testing folders based on 80/20 split
    Images = []
    Classes = []
...
# ACTUAL IMPLEMENTATION OF NETWORK________________________________________________________________________________________________________________________
